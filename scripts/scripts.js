...
function loadDelayed() {
  ...
  if (document.body.classList.contains('reference')) {
    loadCSS(`${window.hlx.codeBasePath}/styles/reference-shell.css`);
    import('./reference-shell.js')
      .then(({ default: initReferenceShell }) => initReferenceShell())
      .catch(() => {});
  }
}
